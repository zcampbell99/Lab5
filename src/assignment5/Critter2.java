...
public class Critter2 extends Critter {
    ...
    public static String runStats2(java.util.List<Critter> critter2) {
        int total_straight = 0;
        int total_left = 0;
        int total_right = 0;
        int total_back = 0;
        ...
        return "" + critter2.size() + " total Critter2    " + "" + critter2Deaths + " total Critter2 deaths    " + "" + total_straight / (GENE_TOTAL * 0.01 * critter2.size()) + "% straight   " + "" + total_back / (GENE_TOTAL * 0.01 * critter2.size()) + "% back   " + "" + total_right / (GENE_TOTAL * 0.01 * critter2.size()) + "% right   " + "" + total_left / (GENE_TOTAL * 0.01 * critter2.size()) + "% left   ";
    }
