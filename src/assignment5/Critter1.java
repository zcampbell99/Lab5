...
public class Critter1 extends Critter {
    ...
    public static String runStats2(java.util.List<Critter> critter1) {
        int total_straight = 0;
        int total_left = 0;
        int total_right = 0;
        int total_back = 0;
        ...
        return "" + critter1.size() + " total Critter1    " + "" + critter1Wins + " total Critter1 wins    " + "" + total_straight / (GENE_TOTAL * 0.01 * critter1.size()) + "% straight   " + "" + total_back / (GENE_TOTAL * 0.01 * critter1.size()) + "% back   " + "" + total_right / (GENE_TOTAL * 0.01 * critter1.size()) + "% right   " + "" + total_left / (GENE_TOTAL * 0.01 * critter1.size()) + "% left   ";
    }
}
